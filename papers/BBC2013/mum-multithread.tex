...
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=2.1in]{static-ft.pdf}}
  \subfloat[]{\includegraphics[width=2.1in]{dynamic-ft.pdf}}
  \subfloat[]{\includegraphics[width=2.1in]{guided-ft.pdf}}
  \caption{Total execution time for OpenMP scheduling.}
  \label{fig:finaltime}
\end{figure}
\begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=2.1in]{static-fm.pdf}}
  \subfloat[]{\includegraphics[width=2.1in]{dynamic-fm.pdf}}
  \subfloat[]{\includegraphics[width=2.1in]{guided-fm.pdf}}
...
\begin{figure}
  \centering
  \subfloat[][]{\includegraphics[width=2.1in]{dcm11.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm12.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm14.pdf}}
  \qquad
  \subfloat[][]{\includegraphics[width=2.1in]{dcm21.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm22.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm24.pdf}}
  \qquad
