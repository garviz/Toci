...
Position in reference sequence, Position in query genome and Length of match.
 ...
 \begin{algorithm}
   ...
   \begin{algorithmic}[1]
    \While{There is more characters in suffix string in query genome AND node is not leaf node AND }
     ...
     \If{There is an node that match the current match character}
