...
\subsubsection{Search for MUMs in a suffix tree} 
...
\label{fig:st}
\end{figure}
In Figure \ref{fig:st} the match gtc which starts at $i+1$ in the query genome and node 7 in the suffix tree is not maximal on the left because the preceding character in both strings is a t.\\
By construction, the location of a match in the suffix tree represents a substring of the subject sequence which maximally matches a prefix of
...
Previously the algorithm for sequence alignment was described in detail. Now our proposal of a parallelization of MUM search within multi-core architecture is explained.\\
...
\begin{figure}[htb]
 ...
 \begin{figure}[htb]
  ...
  \label{fig:misses}
 \end{figure}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm31.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm32.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{dcm34.pdf}}
  \caption{Direct cache misses for OpenMP scheduling and different chunk scheduling.}
  \label{fig:dcm}
\end{figure}
\begin{figure}
  \centering
  \subfloat[][]{\includegraphics[width=2.1in]{l1d11.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d12.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d14.pdf}}
  \qquad
  \subfloat[][]{\includegraphics[width=2.1in]{l1d21.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d22.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d24.pdf}}
  \qquad
  \subfloat[][]{\includegraphics[width=2.1in]{l1d31.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d32.pdf}}
  \subfloat[][]{\includegraphics[width=2.1in]{l1d34.pdf}}
